...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "1", "first_name": "Danjel", "last_name": "Hysenaj", "email": "danjelhysenaj@gmail.com"}`,
	})
...
func TestLoginUserNoError(t *testing.T) {
	...
	assert.EqualValues(t, "Danjel", user.FirstName)
	assert.EqualValues(t, "Hysenaj", user.LastName)
	assert.EqualValues(t, "danjelhysenaj@gmail.com", user.Email)
}
